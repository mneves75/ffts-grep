...
│                                 │         │                                 │
│  git tag v0.10                  │         │  Formula/ffts-grep.rb           │
│         │                       │         │         ▲                       │
│         ▼                       │         │         │                       │
...
on:
  workflow_dispatch:
    inputs:
      version:
        description: 'Version tag (e.g., v0.10)'
        required: true
        type: string
...
1. **You tag a release**: `git tag v0.10 && git push --tags`
...
```bash
gh workflow run bump-formula.yml --repo mneves75/homebrew-tap -f version=v0.10
```
...
| 8 | Test automation with v0.10 release | Both |
