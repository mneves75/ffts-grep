...
This is **version 0.11.1** using **Rust Edition 2024** (requires Rust 1.85+).
...
*Tutorial created using the Feynman Technique for the Rust FTS5 File Indexer project. Version 0.11.1.*
